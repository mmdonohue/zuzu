...
Documentation lists 0 routes but codebase has 7 routes.

**Actual**: 7 routes: Portfolio, ArkOS, MoxiLabs, Navigate, MoxiLabsEvents, MoxiLabsEventDetail, Layout

**Documented**: 0 routes: 

**Recommendation**: Update line 54 to include all routes: Portfolio, ArkOS, MoxiLabs, Navigate, MoxiLabsEvents, MoxiLabsEventDetail, Layout
...
2. Update line 54 to include all routes: Portfolio, ArkOS, MoxiLabs, Navigate, MoxiLabsEvents, MoxiLabsEventDetail, Layout
