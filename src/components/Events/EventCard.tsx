    ...
    >
      ...
      <div className="p-5 flex flex-col gap-3 bg-zinc-300/30">
        ...
        {event.template === "recurring" && event.rrule && (
          <span
            className="inline-flex items-center text-xs font-medium px-2 py-0.5 rounded-full bg-white/[0.05] border border-white/10 w-fit"
            style={{ color: accent }}
          >
            <span
        ...
        <h3 className="text-zinc-100 font-medium text-lg leading-tight">
          {event.title}
        </h3>
