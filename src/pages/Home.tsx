...
function Logo() {
  return (
    <img 
      src={logo} 
      alt="Logo" 
      className="w-32 sm:w-14 md:w-32 lg:w-32"
    />
  );
}
      ...
      >
        <Container maxWidth="md">
          ...
          >
            ...
            <Box sx={{ textAlign: { xs: 'center', md: 'center' }, flexGrow: 1}}>
              ...
              <Box sx={{ mt: 4, display: 'flex', justifyContent: { xs: 'center', md: 'center' }, gap: 2 }}>
                <Button 
                  variant="contained" 
                  color="secondary" 
                  size="large"
